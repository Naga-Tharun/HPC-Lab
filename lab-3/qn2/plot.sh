...
set multiplot layout 1,1 title "Speedup of matrix chain multiplication by varying the number of threads"
set title "matrix chain multiplication" font "Bold,9" offset 1.0,-0.5
