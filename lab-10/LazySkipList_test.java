...
public class LazySkipList_test{
	...
	public LazySkipList_test(int num_threads, int range, int time, int pre_fill, int s_Limit, int i_Limit){
	...
	public static void main(String[] args){
		...
		LazySkipList_test ob = new LazySkipList_test(num_threads,range,time,pre_fill,s_Limit,i_Limit);
